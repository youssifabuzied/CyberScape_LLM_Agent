...
robot1 = {'name': 'robot1',   'skills': ['GoToObject', 'OpenObject', 'CloseObject', 'BreakObject', 'SliceObject', 'SwitchOn', 'SwitchOff', 'PickupObject', 'PutObject', 'DropHandObject', 'ThrowObject', 'PushObject', 'PullObject'], 'mass' : 100}
...
# robot29 --> drone 
robot29 = {'name': 'robot29', 'skills': ["move_to_point", "rotate", "detect_with_camera", "wait_for_signal", "communicate_with_apm", "fly", "return_to_base"]}

# robot30 --> dog
robot30 = {'name': 'robot30', 'skills': ["move_to_point", "rotate", "detect_with_camera" "wait_for_signal", "communicate_with_apm", "jump", "return_to_base", "retrieve_the_object"]}


robots = [robot1, robot2, robot3, robot4, robot5, robot6, robot7, robot8, robot9, robot10,
          robot11, robot12, robot13, robot14, robot15, robot16, robot17, robot18, robot19, robot20, robot21,robot22, robot23, robot24, robot25, robot26, robot27, robot28, robot29, robot30]