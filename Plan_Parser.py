...
def Pparser(plan_file: str, target:str, instruction_format:str) -> str:
    """
...
def main():
    ...
    plan_file_path = robot_cfg["verified"]
    parsed_file = robot_cfg["parsed"]

    instruction_format = robot_cfg["instruction_format"]

    print("Instructions are being parsed.............")

    plan_file = read_file(plan_file_path)
    # print(plan_file)
    filtered_plan = Pparser(plan_file, args.target, instruction_format)
